...
const Accordion = ({
  ...
  const {
    0: rotate,
    1: setRotate
  } = useState('transform duration-700 ease');
  const contentSpace = useRef(null);

  function toggleAccordion() {
    setActive(active === false ? true : false); // @ts-ignore

    setHeight(active ? '0px' : '50px'); //`${contentSpace.current.scrollHeight}px`
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(869);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _accordion_Accordion__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6038);
...
const Resume = ({
  ...
  const {
    0: hoverFont,
    1: setHoverFont
  } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)("1.5rem");
  const hoverStyles = {
    fontSize: `${hoverFont}`,
    transition: "2s"
  };
  ...
  const {
    0: height,
    1: setHeight
  } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)('0px');
  const {
    0: transition,
    1: setTransition
  } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)('2s');
  const contentSpace = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    ...
    className: "text-center text-sm sm:text-2xl mb-2 "
  }, text2), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    ref: contentSpace,
    style: {
      maxHeight: `${height}`
    },
    ...
    className: "jutifynospace pl-2 pr-2 sm:pl-10 pb-10 sm:pr-10 text-sm sm:text-lg text-justify"
  }, content, "  "))));
};
...
// EXTERNAL MODULE: ./src/components/resume/resume.tsx
var resume = __webpack_require__(8990);
// EXTERNAL MODULE: ./src/components/accordion/Accordion.tsx
var Accordion = __webpack_require__(6038);
...
const Card = ({
  ...
  return /*#__PURE__*/index_js_default().createElement("div", {
    ...
    id: "jahr-hover-id",
    className: "text-2xl text-left text-white mt-6  jahr-hover",
    style: hoverStyles
  }, projectart), /*#__PURE__*/index_js_default().createElement((react_responsive_default()), {
    minDeviceWidth: 1224
  }, /*#__PURE__*/index_js_default().createElement("div", {
    id: "bord1",
    onClick: Object.assign(toggleAccordion, rollupStyles),
    ...
    className: "text-center text-4xl font-bold mt-2"
  }, text1), /*#__PURE__*/index_js_default().createElement("div", {
    className: "rounded mx-64 my-4"
  }), /*#__PURE__*/index_js_default().createElement(image_image/* default */.Z, {
    imageName: imageCard,
    maxWidth: 250,
    className: "   "
  }), /*#__PURE__*/index_js_default().createElement("h3", {
    className: "text-center text-2xl mb-2 "
  }, text2), /*#__PURE__*/index_js_default().createElement("div", {
    ref: contentSpace,
    style: {
      maxHeight: `${height}`
    },
    ...
    className: "pl-10 pb-10 pr-10"
  }, content, "  ")))), /*#__PURE__*/index_js_default().createElement((react_responsive_default()), {
    maxDeviceWidth: 1224
  }, /*#__PURE__*/index_js_default().createElement("div", {
    id: "bord1",
    onClick: Object.assign(toggleAccordion, rollupStyles),
    onMouseOver: () => setHoverFont("1.6rem"),
    onMouseOut: () => setHoverFont("1.5rem"),
    className: "border-black bg-white h:24 sm:h-38 w-11/12 sm:w-4/5 mb-8 mr-5 breitelinks border-black border-2 z-10 ml-0 hover:bg-opacity-40 hover:border-white hover-radius "
  }, /*#__PURE__*/index_js_default().createElement("h2", {
    className: "text-center text-4xl font-bold mt-2"
    ...
    className: "text-justify textjustify pl-10 pb-10 pr-10"
  }, content, "  ")))));
};
...
;// CONCATENATED MODULE: ./node_modules/react-scroll-horizontal/dist/index.es.js
...
var _react2 = _interopRequireDefault((index_js_default()));



var _propTypes2 = _interopRequireDefault((prop_types_default()));
...
var ScrollHorizontal = function (_Component) {
  ...
  createClass(ScrollHorizontal, [{
    ...
    value: function componentDidMount() {
      ...
      react_dom.findDOMNode(this.hScrollParent).addEventListener('wheel', this.onScrollStart, { passive: false });
    }
  }, {
    ...
    value: function componentWillUnmount() {
      ...
      react_dom.findDOMNode(this.hScrollParent).removeEventListener('wheel', this.onScrollStart);
    }
  }, {
    key: 'onScrollStart',
    ...
    value: function caniscroll() {
      var el = react_dom.findDOMNode(this.hScrollParent);
    ...
    value: function calculate() {
      ...
      this.calculate.timer = setTimeout(function () {
        ...
        var el = react_dom.findDOMNode(_this3.hScrollParent);
...
ScrollHorizontal.propTypes = {
  reverseScroll: (prop_types_default()).bool,
  pageLock: (prop_types_default()).bool,
  config: (prop_types_default()).object,
  style: (prop_types_default()).object,
  className: (prop_types_default()).string,
  children: (prop_types_default()).array.isRequired,
  animValues: (prop_types_default()).number
};
...
/* harmony default export */ const index_es = (ScrollHorizontal);
...
;// CONCATENATED MODULE: ./src/components/layout/main/layoutThree.tsx
...
const LayoutThree = ({
  ...
  href: "mailto:info@it-iz.de"
}, "Contact"))))), /*#__PURE__*/index_js_default().createElement((react_responsive_default()), {
  maxDeviceWidth: 1224
}, /*#__PURE__*/index_js_default().createElement("div", {
  className: "flex flex-col abstandOben w-3/4 ml-0 overflow-x-hidden"
}, /*#__PURE__*/index_js_default().createElement("div", {
  className: "w-1/1    absolute top-0 text-right text-l sm:text-2xl position-left mr-4 overflow-x-hidden"
}, /*#__PURE__*/index_js_default().createElement("h1", null, /*#__PURE__*/index_js_default().createElement("span", {
  className: "text-primary"
}, "Pro"), /*#__PURE__*/index_js_default().createElement("span", {
  className: "text-secondary"
}, "jects"))), /*#__PURE__*/index_js_default().createElement(card, {
  text1: "immajung",
  text2: "www.immajung.de",
  content: "F\xFCr das Modelabel welches ich und einige Kollegen f\xFChren haben wir den Shop mit Typescript, Gatsby und Snipcart gebaut. Die Seite haben wir selbst designed, wir wollten au\xDFergew\xF6hnliche Elemente mit einbauen, womit sich jeder Software-Entwickler mit identifiziert",
  projectart: 'Typescript - Gatsby - Snipcart - Netlify',
  imageCard: "picfarbe_ili.png"
}), /*#__PURE__*/index_js_default().createElement(card, {
  text1: "FSW-Media",
  text2: "www.fsw-media.com",
  content: "Die FSW-Media Seite habe ich in zusammenarbeit mit der Agentur  Montary-Agency entwickelt, dabei wurde die Seite ausschlie\xDFlich React benutzt. Die Seite wurde auf einem eigenen Webserver gehosted.",
  projectart: 'React',
  imageCard: "picfarbe_ili.png"
}), /*#__PURE__*/index_js_default().createElement(card, {
  text1: "endlichlernen",
  text2: "www.endlichlernen.de",
  content: "Als die Schulen geschlossen wurden und alle Kids von Zuhause aus dem Unterricht folgen mussten, haben wir ein Projekt gestartet welches Schulen mit Equipment ausstatet , sodass die Kinder von uhasue aus \xFCber ein Webkonferenzraum dem Unterricht folgen konnten, darin inbegriffen wwar ein Online Studnenplan und ein Login f\xFCr die Kinder.",
  projectart: 'Linux-Server - Webkonferenzraum',
  imageCard: "picfarbe_ili.png"
}), /*#__PURE__*/index_js_default().createElement(card, {
  text1: "Testpoint-Hannover",
  text2: "www.test-point-hannover.de",
  ...
  className: "w-1/1    absolute top-0 text-right text-6xl position-left "
}, /*#__PURE__*/index_js_default().createElement("h1", null, /*#__PURE__*/index_js_default().createElement("span", {
  className: "text-primary"
}, "Pro"), /*#__PURE__*/index_js_default().createElement("span", {
  className: "text-secondary"
}, "jects"))), /*#__PURE__*/index_js_default().createElement(index_es, {
  reverseScroll: true,
  className: "ml-4"
}, /*#__PURE__*/index_js_default().createElement(card, {
  text1: "immajung",
...
/* harmony default export */ const layoutThree = (LayoutThree);
...
const TimelinePage = () => /*#__PURE__*/index_js_default().createElement(layoutThree, {
  title: "Projects",
  pageName: "Projects",
  description: "Ilias Zales Projekte",
  type: "kp",
  image: "no"
}, /*#__PURE__*/index_js_default().createElement(Seo/* default */.Z, {
  title: "Projects Ilias Zales",
  metaDescription: "Ilias Zales Projects"
}));

/* harmony default export */ const projects = (TimelinePage);
