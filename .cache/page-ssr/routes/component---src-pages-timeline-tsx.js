...
;// CONCATENATED MODULE: ./src/components/layout/main/layoutTwo.tsx
...
const LayoutTwo = ({
  ...
  className: "flex flex-row bg-gradient min-h-screen w-1/1  "
  ...
  className: " inset-y-2/3   ml-4  flex text-center justify-center rounded-full  sticky-button border-black bg-white w-12 sm:w-48 h-12 sm:h-12 hover:bg-secondary hover:text-white border-black border-2"
  ...
  className: "overflow-scroll abstandOben w-3/4 -ml-4"
}, /*#__PURE__*/index_js_default().createElement("div", {
  className: "w-1/1 absolute top-0 text-right text-l sm:text-6xl position-left "
}, /*#__PURE__*/index_js_default().createElement("h1", null, /*#__PURE__*/index_js_default().createElement("span", {
  className: "text-secondary"
}, "Time"), /*#__PURE__*/index_js_default().createElement("span", {
  className: "text-primary"
}, "line"))), /*#__PURE__*/index_js_default().createElement(resume/* default */.Z, {
  text1: "Freelancer als Software-Developer in der Frontend & Backend Entwicklung",
  text2: "it-iz.de",
  content: "Als Selbstst\xE4ndiger habe ich seit 2019 gestartet, nach meinem Bachelor startete ich bei einer Firma f\xFCr die Herstellung von M\xF6beln. Danach folgten Auftr\xE4ge f\xFCr die Digitalisierung von Schulen, dabei wurde ein Video-KOnferenzraum entwickelt, wo die Sch\xFCler von Zuhause dem Unterricht im Klassenraum folgen konnten. Weitere Webentwicklungsauftr\xE4ge folgten.",
  start: "2019",
  end: "2022"
}), /*#__PURE__*/index_js_default().createElement(resume/* default */.Z, {
  text1: "Design and Management - Modelabel",
  text2: "Binary-Cult",
  content: "Dieses Projekt enstand durch das Interesse an Mode, einige alte Kommulitonen und ich erstellten unser eigenes Modelabel f\xFCr coole Kleidung die Entwickler und Tech interissierte tragen wollen.",
  start: "2019",
  end: "2022"
}), /*#__PURE__*/index_js_default().createElement(resume/* default */.Z, {
  text1: "Software-Developer Frontend & Backend-Entwicklung",
  text2: "Marketing Agentur Montary-Agency",
  content: "F\xFCr die Agentur Montary-Agency arbeitete ich ein Jahr, als Forn & Backend entwickler, dabei waren die meisten Auftr\xE4ge als Frontend entwickler mit React und Typescript.",
  start: "2021",
  end: "2022"
}), /*#__PURE__*/index_js_default().createElement(resume/* default */.Z, {
  text1: "Trainer f\xFCr Kinder Und Erwachsene (Kampfkunst)",
  text2: "TA WingTsun (Kampfkunst)",
  content: "Mit 11 Jahren fing ich die Kampfkunst TA WingTsun an, diese begleitet mich also schon mein lebenlang, schnell wurde mir klar, dass ein draht zu kindern und Jugendliche habe, deshalb entschied ich mich mit 14 Jahren als Assisten im Kindertraining mitzuwirken, nach der Ausbildung als Trainer konnte ich eigenverantwortlich unter der Leitung meines Si-Fu's (Lehrer) Kinder und Erwachsenenkurse in Hannover leiten, ich durfte au\xDFerdem an vielen Kursen f\xFCr Schulen und \xF6ffentlichen Einrichtungen Kurse f\xFCr Gewaltpr\xE4vention und Sicheheit leiten.  ",
  start: "2016",
  end: "2022"
}), /*#__PURE__*/index_js_default().createElement(resume/* default */.Z, {
  text1: "Administration und Webentwicklung",
  text2: "TA WingTsun (Kampfkunst)",
  content: "Als Trainer f\xFCr Kinder und Erwachsene im TA WingTsun \xFCbernahm ich auch die Webentwicklung und den Internetauftritt.",
  start: "2018",
  end: "2020"
}), /*#__PURE__*/index_js_default().createElement(resume/* default */.Z, {
  text1: "Qualit\xE4tsmanagement",
  text2: "Finanzinformatik",
  content: "Als Werkstudent habe ich in der Finanzinformatik f\xFCr die Qualit\xE4tsicherung an der IF6 gearbeitet. Meine Aufgaben waren Testdurchf\xFChrungen und Loganalyse f\xFCr die Internet-Filiale durchzuf\xFChren.",
  start: "2017",
  end: "2018"
}), /*#__PURE__*/index_js_default().createElement(resume/* default */.Z, {
  text1: "Gesch\xE4ftsf\xFChrer eines Bistros",
  text2: "Blauen See Garbsen",
  content: "In jungen Jahren \xFCbernham ich die Verantwortung eines der Lokale meiner Familie, dies st\xE4rkte mich schon Selbst\xE4ndig zu organisieren und zu Leiten, stress war bei dieser Arbeit Tagesordnung.",
  start: "2014",
  end: "2015"
}))));

/* harmony default export */ const layoutTwo = (LayoutTwo);
...
const TimelinePage = () => /*#__PURE__*/index_js_default().createElement(layoutTwo, {
  title: "Timeline",
  pageName: "Timeline",
  description: "Timeline Ilias Zales",
  type: "kp",
  image: "no"
}, /*#__PURE__*/index_js_default().createElement(Seo/* default */.Z, {
  title: "Timeline Ilia Zales",
  metaDescription: "Timeline Ilias Zales"
}));

/* harmony default export */ const timeline = (TimelinePage);
...
;
//# sourceMappingURL=component---src-pages-timeline-tsx.js.map